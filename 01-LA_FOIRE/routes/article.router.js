...
import { postArticle, getAllArticles, getAllArticlesSortedByPrice, getAllArticlesSortedByPriceDesc, getArticleById, deleteArticle, updateArticle, getArticlesByRating} from '../controllers/article.controller.js';  // Contrôleur des articles
...
router.delete('/deleteArticle/:id', verifieToken, deleteArticle);
// Route put pour modifier un article avec Id
router.put("/updateArticle/:id", verifieToken, updateArticle);
// Exporter le routeur
